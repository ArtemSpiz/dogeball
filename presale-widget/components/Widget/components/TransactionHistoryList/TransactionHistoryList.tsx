...
const TransactionHistoryList = () => {
  ...
  const groupedTransactions = useMemo(() => {
    const groups: {
      ...
      transactions: API.TransactionHistoryItemV2[];
    }[] = [];
    ...
    const getSortOrder = (a: API.TransactionHistoryItemV2["record_type"]) =>
      ({
        transaction: 0,
      ...
      {loading ? (
        ...
        <>
          {formattedTransactions.length === 0 && (
            <p className="text-center">You have no transactions</p>
          )}
              ...
              <div className={classes["tags"]}>
                {[
                  ...
                  "stage_name" in trx && trx.stage_name
                    ? { text: trx.stage_name, bg: "#333", textColor: "#fff" }
                    : undefined,
                ]
                  ...
                  <div className={classes["info-text-container"]}>
                    ...
                    {trx.extras.length > 0 && (
                      <div className={classes["extras"]}>
                        {trx.extras.map((extra, idx) => {
                          return (
                            <div key={idx} className={classes["extra"]}>
                              <svg
