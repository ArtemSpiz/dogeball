...
const FAQcards = [
  {
    ...
    text: `$DOGEBALL is a dual-utility coin that powers a custom Layer 2 blockchain designed for near zero-fee transactions, high speed, and top-tier security, seamlessly integrated with the $DOGEBALL online game. As the native token, $DOGEBALL fuels the entire ecosystem, offering a robust foundation for users and gamers alike. Tokens have a real-life utility and will be used for completing transactions in the gaming industry in the future.' section in 'HOW TO BUY ABOVE'. <a href="#howToBuy" class="underline">Click Here</a>`,
  },
  {
...
<template>
  ...
  >
    <div class="title z-20 max-w-[800px] text-center mx-auto">
    ...
    <div
      class="flex z-30 flex-col gap-4 max-w-7xl mx-auto px-4 max-md:h-[640px]"
    >
      <div class="grid grid-cols-2 max-md:grid-cols-1 gap-4">
        <div class="flex flex-col gap-4">
          <div
            ...
            :key="isMobile ? i : i * 2"
            class="p-8 max-md:p-4 gap-4 w-full max-w-[500px] backdrop-blur-sm relative bg-[rgba(53,19,147,0.52)] rounded-2xl flex flex-col transition-all"
          >
            <div
            ...
            <Transition name="expand">
              <p
                ...
                v-html="card.text"
                class="text-base leading-[120%] z-50 pl-12 max-md:pl-0"
              />
            </Transition>
          </div>
        </div>
        ...
        <div class="flex flex-col gap-4 max-md:hidden">
          <div
            ...
            :key="i * 2 + 1"
            class="p-8 gap-4 w-full max-w-[500px] backdrop-blur-sm relative bg-[rgba(53,19,147,0.52)] rounded-2xl flex flex-col transition-all"
          >
            <div
              class="absolute inset-0 rounded-2xl"
              style="
