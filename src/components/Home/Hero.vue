...
<template>
  <div
    class="h-screen 2xl:h-[1500px] 2xl:bg-bottom max-md:h-[calc(100vh-30px)] relative min-h-[600px] px-5 pt-[100px] flex flex-col items-center justify-between pb-[56px] bg-[url('@/assets/img/Home/HeroBg.png')] max-xl:!bg-cover bgFill bg-[center_bottom] bg-no-repeat"
  >
    ...
    >
      ...
      <div
        class="w-[230px] max-md:w-[200px] absolute bottom-[-40px] max-lg:bottom-[250px] max-md:top-[360px] max-md:bottom-auto right-[120px] max-md:right-[10px] aspect-square"
      >
